...
<?php
  ...
  require_once('sql.php'); // Include your sql.php file
?>
<?php
// Make sure these functions return arrays
$c_enrollees = count_enrolled() ?? ['total' => 0];
$c_courses = count_courses() ?? ['total' => 0];
$c_email = count_by_id('usertable') ?? ['total' => 0];
$c_verified = count_active('students') ?? ['total' => 0];
?>
