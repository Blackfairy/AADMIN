...
if (isset($_POST['add_students'])) {
    ...
    if (empty($errors)) {
        ...
        $query .=" first_name, last_name, contact, university, address, date_of_birth, gender, student_email";
        $query .=") VALUES (";
        $query .=" '{$s_firstname}', '{$s_lastname}', '{$s_contact}','{$s_university}','{$s_address}','{$s_dob}', '{$s_gender}','{$s_semail}'";
        $query .=")";
