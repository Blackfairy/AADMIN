  ...
  <body>
    <section class="container">
      <header>Registration Form</header>
                    <form method="post" action="enroll.php" class="form">
                            ...
                            <div class="input-box">
                                <input type="text" class="form-control" name="llname" placeholder="Last Name">
                                    ...
                                    <div class="input-box">
                                <button type="submit" name="enroll" class="btn">Add students</button>
                                    </div>
